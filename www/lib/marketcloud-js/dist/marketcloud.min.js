...
d.carts.getByUser=function(c,a){e("/carts",{owner:c},function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.carts["delete"]=function(c,a){h("/carts/"+c,function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};q.marketcloud=d})();